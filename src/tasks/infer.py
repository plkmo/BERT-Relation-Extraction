...
class infer_from_trained(object):
    def __init__(self, args=None, detect_entities=False):
        ...
        if self.args.model_type == 'BERT':
            ...
            lower_case = True
            model_name = 'BERT'
            self.net = BertModel.from_pretrained(model, force_download=False,
            ...
            lower_case = False
            model_name = 'ALBERT'
            self.net = AlbertModel .from_pretrained(model, force_download=False,
                                                    model_size=args.model_size,
                                                    task='classification', n_classes_=self.args.num_classes)
...
class FewRel(object):
    def __init__(self, args=None):
        ...
        if self.args.use_pretrained_blanks == 1:
            ...
            checkpoint_path = "./data/test_checkpoint_%d.pth.tar" % self.args.model_type
